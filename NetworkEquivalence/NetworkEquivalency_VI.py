...
Wide_sub5 = twin(X, Arm5_weights, Arm5_biases)
Wide_sub6 = twin(X, Arm6_weights, Arm6_biases)
Wide_sub7 = twin(X, Arm7_weights, Arm7_biases)


output_layer = -Wide_sub1- Wide_sub2 - Wide_sub3 -Wide_sub4 - Wide_sub5 - Wide_sub6 - Wide_sub7 + final_bias

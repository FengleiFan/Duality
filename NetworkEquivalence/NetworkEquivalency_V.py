...
Deep_sub6  = twin(Deep_sub5, DeepArm_5_weights, DeepArm_4_biases)
Deep_sub7  = twin(Deep_sub6, DeepArm_Output_weights, DeepArm_Output_biases)



output_layer_2 = Deep_sub7
       ...
       for i in range(1, num_steps+1):
        ...
        # Display logs per step
          if i % 1000 == 0:
            ...
            Prediction = sess.run(accuracy, feed_dict={X: input_data, Y: output_data})

            
       save_output[0,k] = Prediction

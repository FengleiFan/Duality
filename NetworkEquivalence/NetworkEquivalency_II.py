...
Deep_sub4  = twin(Deep_sub3, DeepArm_3_weights, DeepArm_3_biases)
Deep_sub5  = twin(Deep_sub4, DeepArm_Output_weights, DeepArm_Output_biases)

output_layer_1 = -Wide_sub1- Wide_sub2  + final_bias

output_layer_2 = Deep_sub5
